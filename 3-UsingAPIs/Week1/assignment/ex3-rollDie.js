...
//The promise only settle once, resolve or reject. After that, any settlement attempt is ignored.
//Since we have only one settlement, then() or catch() works only once.

//While with callbacks any calling is accepted, therefore many settlements.
