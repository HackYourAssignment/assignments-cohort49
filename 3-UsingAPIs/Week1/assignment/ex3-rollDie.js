...
function main() {
  rollDie()
    .then((value) => console.log(`Final die value is: ${value}`))
...
// by using promises instead of callbacks, the flow becomes easier to manage, it ensures the die is resolved or errors are properly caught.
