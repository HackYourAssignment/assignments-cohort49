...
function main() {
  ...
  const partnerNames = ['Alex', 'Taylor', 'Jordan', 'Morgan', 'Casey'];

  const locations = ['New York', 'Paris', 'Tokyo', 'Sydney', 'Cape Town'];

  const jobTitles = ['Software Developer', 'Teacher', 'Doctor', 'Artist', 'Engineer'];
